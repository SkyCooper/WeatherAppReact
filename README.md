...
## Check The Live Website ➡️ [Live Website](https://cooper-weatherapp-react.netlify.app/)
...
Project aims to create an weather app using React.
...
- 🔥 You can use [`OpenWeather-API`](https://openweathermap.org/) for your own work.
